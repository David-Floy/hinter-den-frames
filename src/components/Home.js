...
const Home = ({posts}) => {
    ...
    <div>
        ...
        <div className="klapptext-container">
          ...
          <p id="klapptext" className="klapptext">Wir sind Rahel, David und Marvin und haben uns für ein Uni-Projekt dazu entschieden einen Film- und Serienblog zu erstellen, weil wir Bewegtbildproduktionen lieben! <br>Wir wünschen euch viel Spaß beim stöbern </p>
        </div>
