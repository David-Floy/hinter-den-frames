    ...
    const posts = [
        ...
        { id: 3, title: 'Unterm Radar?', 
            ...
            content1: 'Ich bin also mehr oder weniger nach Belieben vorgegangen, ohne irgendeinem bestimmten Schema F zu folgen. \n' +
                ...
                'Ein Kinoflop mit 38 Mio. Dollar Produktionsbudget und \n' +
                ...
                'Der Cast, die Bilder, Spiel und Story waren sehr stimmig. Vielleicht, \n' +
                'weil das Thema um Feuerwehrmänner im Kampf gegen die Flammen zu altbacken oder unoriginell \n' +
                'erscheint? Ich weiß es nicht. \n' +
                'Die Filmbiografie handelt von einer Truppe Feuerwehrmänner, \n' +
                ...
                'Hier entstehen auch außerhalb des Kampfes \n' +
            ...
            content2: 'The Nice Guys (2016): \n' + 
                'Ein meiner Meinung nach sehr unterhaltsamer Film, der die ikonische Buddy-/Actionkomödie \n' +
                ...
                'The Nice Guys wirft uns zurück in die 70er Jahre und liefert uns eine großartige Story, einen \n' +
                'fantastischen Cast und eine insgesamt abwechslungsreiche Mischung aus Spaß und Spannung. \n' +
                'Natürlich erfindet The Nice Guys, auch aufgrund des Genres, das Rad nicht neu, hat aber durchaus \n' +
                ...
                'Hugo Cabret (2011): \n' +
                'Auch Martin Scorsese kann Flops. Auch wenn 180 Mio. Dollar nicht gering klingen \n' +
                ...
                'Ich denke ganz unbekannt dürfte der Film nicht sein, \n' +
                'da er aber als Flop gehandelt wird, wollte ich ihn trotzdem erwähnen. \n'+
                'Hugo Cabret ist eine Hommage auf das Kino an sich und auf einen der Pioniere der Filmgeschichte. \n' +
                ...
                'Ein wahrlich abschreckender Titel. \n' +
                'So abschreckend, dass der Film niemand in die Kinosäle locken konnte. \n' +
                'Dabei ist „DEDJJDDFRF“ (klingt selbst abgekürzt grauenvoll) eines der am meisten abgerundeten Dramen, \n' +
                ...
                'Nebenbei betreibt der Western eine stringente Auseinandersetzung von \n' +
